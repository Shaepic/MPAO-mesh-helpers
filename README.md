...
To use the regular subtract blend method(may be less precise in some engines), simply invert the textures in a photo editor. Note it is also possible to shade the meshes with a simple sdf function that
